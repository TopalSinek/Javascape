...
public class Question_1_4 extends Question {
	...
	public Question_1_4() {
		...
		public boolean test(Class myClass)throws Exception{
			...
			Method withoutDoublesMethod = myClass.getMethod("withoutDoubles", int.class,int.class, boolean.class);
			
			
			//test method
			Object resB = withoutDoublesMethod.invoke(myClass.newInstance(), 2, 3, true);
